...
| owners       | []               | Identities allowed to see and manage this host once [authentication](./authentication.md) is enabled. Empty means admin-only. Ignored entirely while authentication is disabled. |
