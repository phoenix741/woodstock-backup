 ...
 */
export function graphql(
  source: 'query ArchiveProfiles {\n  archiveProfiles {\n    name\n    enabled\n    format\n    destination\n    scheduleCron\n    checksum\n    compressionLevel\n    hostSelectionMode\n    hostSelectionPattern\n    hostSelectionHosts\n  }\n}',
): (typeof documents)['query ArchiveProfiles {\n  archiveProfiles {\n    name\n    enabled\n    format\n    destination\n    scheduleCron\n    checksum\n    compressionLevel\n    hostSelectionMode\n    hostSelectionPattern\n    hostSelectionHosts\n  }\n}'];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: 'mutation runArchive($profile: String!, $host: String) {\n  runArchive(profile: $profile, host: $host) {\n    jobIds\n  }\n}',
 ...
 */
export function graphql(
  source: 'query Backup($hostname: String!, $id: String!) {\n  backup(hostname: $hostname, id: $id) {\n    id\n    number\n    status {\n      ...BackupStatusFields\n    }\n    startDate\n    endDate\n    errorCount\n    fileCount\n    newFileCount\n    existingFileCount\n    removedFileCount\n    modifiedFileCount\n    fileSize\n    newFileSize\n    existingFileSize\n    speed\n    shareRecords {\n      path\n      snapshotMethod\n      snapshotFailureReason\n    }\n  }\n}',
 ...
 */
export function graphql(
  source: 'query BackupsBrowse($hostname: String!, $id: String!, $sharePath: String!, $path: Buffer!) {\n  backup(hostname: $hostname, id: $id) {\n    id\n    files(sharePath: $sharePath, path: $path) {\n      ...FragmentFileDescription\n    }\n  }\n}',
 ...
 */
export function graphql(
  source: 'mutation purgeRetention($hostname: String!) {\n  purgeRetention(hostname: $hostname) {\n    id\n  }\n}',
): (typeof documents)['mutation purgeRetention($hostname: String!) {\n  purgeRetention(hostname: $hostname) {\n    id\n  }\n}'];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: 'mutation removeBackup($hostname: String!, $id: String!) {\n  removeBackup(hostname: $hostname, id: $id) {\n    id\n  }\n}',
): (typeof documents)['mutation removeBackup($hostname: String!, $id: String!) {\n  removeBackup(hostname: $hostname, id: $id) {\n    id\n  }\n}'];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: 'fragment BackupStatusFields on BackupStatusDto {\n  statusType\n  finishingStage\n  abortingStage\n  failedStage\n  removingStage\n}',
 ...
 */
export function graphql(
  source: 'query SharesBrowse($hostname: String!, $id: String!) {\n  backup(hostname: $hostname, id: $id) {\n    id\n    shares {\n      ...FragmentFileDescription\n    }\n  }\n}',
): (typeof documents)['query SharesBrowse($hostname: String!, $id: String!) {\n  backup(hostname: $hostname, id: $id) {\n    id\n    shares {\n      ...FragmentFileDescription\n    }\n  }\n}'];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: 'query PoolHealth {\n  poolHealth {\n    healthy\n    isDirty\n    pendingCount\n  }\n}',
): (typeof documents)['query PoolHealth {\n  poolHealth {\n    healthy\n    isDirty\n    pendingCount\n  }\n}'];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: 'mutation cancelJob($taskId: String!) {\n  cancelJob(taskId: $taskId)\n}',
