 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "query Events($firstEvent: DateTime!, $lastEvent: DateTime!) {\n  events(firstEvent: $firstEvent, lastEvent: $lastEvent) {\n    uuid\n    type\n    step\n    source\n    timestamp\n    errorMessages\n    status\n    information {\n      __typename\n      ... on EventBackupInformation {\n        hostname\n        number\n        sharePath\n      }\n      ... on EventRefCountInformation {\n        fix\n        count\n        error\n      }\n      ... on EventPoolInformation {\n        fix\n        inUnused\n        inRefcnt\n        inNothing\n        missing\n      }\n      ... on EventPoolCleanedInformation {\n        size\n        count\n      }\n    }\n  }\n}"): (typeof documents)["query Events($firstEvent: DateTime!, $lastEvent: DateTime!) {\n  events(firstEvent: $firstEvent, lastEvent: $lastEvent) {\n    uuid\n    type\n    step\n    source\n    timestamp\n    errorMessages\n    status\n    information {\n      __typename\n      ... on EventBackupInformation {\n        hostname\n        number\n        sharePath\n      }\n      ... on EventRefCountInformation {\n        fix\n        count\n        error\n      }\n      ... on EventPoolInformation {\n        fix\n        inUnused\n        inRefcnt\n        inNothing\n        missing\n      }\n      ... on EventPoolCleanedInformation {\n        size\n        count\n      }\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
