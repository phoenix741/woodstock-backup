 ...
 */
export function graphql(
  source: 'query Host($hostname: String!) {\n  host(hostname: $hostname) {\n    name\n    agentVersion\n    lastBackup {\n      agentVersion\n      completed\n    }\n    availibilityState\n    timeSinceLastBackup\n    dateToNextBackup\n    lastBackupState\n    addresses\n    configuration {\n      operations {\n        preCommands {\n          command\n        }\n        operation {\n          shares {\n            name\n          }\n        }\n        postCommands {\n          command\n        }\n      }\n      schedule {\n        activated\n      }\n    }\n  }\n}',
 ...
 */
export function graphql(
  source: 'query Backup($hostname: String!, $number: Int!) {\n  backup(hostname: $hostname, number: $number) {\n    id\n    number\n    completed\n    startDate\n    endDate\n    errorCount\n    fileCount\n    newFileCount\n    existingFileCount\n    removedFileCount\n    modifiedFileCount\n    fileSize\n    newFileSize\n    existingFileSize\n    speed\n  }\n}',
): (typeof documents)['query Backup($hostname: String!, $number: Int!) {\n  backup(hostname: $hostname, number: $number) {\n    id\n    number\n    completed\n    startDate\n    endDate\n    errorCount\n    fileCount\n    newFileCount\n    existingFileCount\n    removedFileCount\n    modifiedFileCount\n    fileSize\n    newFileSize\n    existingFileSize\n    speed\n  }\n}'];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: 'query Backups($hostname: String!) {\n  backups(hostname: $hostname) {\n    id\n    number\n    completed\n    startDate\n    endDate\n    errorCount\n    fileCount\n    newFileCount\n    existingFileCount\n    removedFileCount\n    modifiedFileCount\n    fileSize\n    newFileSize\n    existingFileSize\n    speed\n  }\n}',
): (typeof documents)['query Backups($hostname: String!) {\n  backups(hostname: $hostname) {\n    id\n    number\n    completed\n    startDate\n    endDate\n    errorCount\n    fileCount\n    newFileCount\n    existingFileCount\n    removedFileCount\n    modifiedFileCount\n    fileSize\n    newFileSize\n    existingFileSize\n    speed\n  }\n}'];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: 'query BackupsBrowse($hostname: String!, $number: Int!, $sharePath: String!, $path: String!) {\n  backup(hostname: $hostname, number: $number) {\n    id\n    files(sharePath: $sharePath, path: $path) {\n      ...FragmentFileDescription\n    }\n  }\n}',
): (typeof documents)['query BackupsBrowse($hostname: String!, $number: Int!, $sharePath: String!, $path: String!) {\n  backup(hostname: $hostname, number: $number) {\n    id\n    files(sharePath: $sharePath, path: $path) {\n      ...FragmentFileDescription\n    }\n  }\n}'];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: 'mutation createBackup($hostname: String!) {\n  createBackup(hostname: $hostname) {\n    id\n  }\n}',
): (typeof documents)['mutation createBackup($hostname: String!) {\n  createBackup(hostname: $hostname) {\n    id\n  }\n}'];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: 'mutation removeBackup($hostname: String!, $number: Int!) {\n  removeBackup(hostname: $hostname, number: $number) {\n    id\n  }\n}',
): (typeof documents)['mutation removeBackup($hostname: String!, $number: Int!) {\n  removeBackup(hostname: $hostname, number: $number) {\n    id\n  }\n}'];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: 'fragment FragmentFileDescription on FileDescription {\n  path\n  type\n  stats {\n    ownerId\n    groupId\n    mode\n    size\n    lastModified\n  }\n  symlink\n}',
): (typeof documents)['fragment FragmentFileDescription on FileDescription {\n  path\n  type\n  stats {\n    ownerId\n    groupId\n    mode\n    size\n    lastModified\n  }\n  symlink\n}'];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: 'query SharesBrowse($hostname: String!, $number: Int!) {\n  backup(hostname: $hostname, number: $number) {\n    id\n    shares {\n      ...FragmentFileDescription\n    }\n  }\n}',
