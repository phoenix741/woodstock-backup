...
export type EventRefCountInformationFragment = {
  __typename?: 'EventRefCountInformation';
  fix: boolean;
  count: number;
  error: number;
} & { ' $fragmentName'?: 'EventRefCountInformationFragment' };
...
export type HostQuery = {
  ...
  host: {
    ...
    dateToNextBackup?: string | null;
    lastBackupState?: string | null;
    addresses?: Array<string> | null;
    lastBackup?: { __typename?: 'Backup'; agentVersion?: string | null; completed: boolean } | null;
    configuration: {
      __typename?: 'HostConfiguration';
      operations?: {
        __typename?: 'HostConfigOperation';
...
export type ClearCacheMutation = {
  __typename?: 'Mutation';
  clearCache: { __typename?: 'ClearCacheResponse'; void?: number | null };
};
...
export type VerifyChecksumMutation = {
  __typename?: 'Mutation';
  verifyChecksum: { __typename?: 'JobResponse' } & {
    ' $fragmentRefs'?: { JobPoolResponseFragment: JobPoolResponseFragment };
  };
};
...
export type PoolStatisticsQuery = {
  ...
  statistics: {
    ...
    poolUsage?: {
      ...
      size?: bigint | null;
      compressedSize?: bigint | null;
      compressedSizeLastMonth?: bigint | null;
      unusedSize?: bigint | null;
      nbChunkRange?: Array<{ __typename?: 'NumberTimeSerie'; time: number; value: number }> | null;
      compressedSizeRange?: Array<{ __typename?: 'BigIntTimeSerie'; time: number; value: bigint }> | null;
    } | null;
  };
};

export type ProgressTaskFragment = {
  __typename?: 'JobProgression';
...
type TaskDescription_JobGroupTasks_Fragment = { __typename: 'JobGroupTasks' } & {
  ' $fragmentName'?: 'TaskDescription_JobGroupTasks_Fragment';
};

type TaskDescription_JobSubTask_Fragment = {
  __typename: 'JobSubTask';
  taskName: string;
  description?: string | null;
  state?: QueueTaskState | null;
} & { ' $fragmentName'?: 'TaskDescription_JobSubTask_Fragment' };

export type TaskDescriptionFragment = TaskDescription_JobGroupTasks_Fragment | TaskDescription_JobSubTask_Fragment;

type BackupTask_JobGroupTasks_Fragment = {
  __typename: 'JobGroupTasks';
  groupName?: string | null;
  description?: string | null;
  state?: QueueTaskState | null;
  progression?:
    | ({ __typename?: 'JobProgression' } & { ' $fragmentRefs'?: { ProgressTaskFragment: ProgressTaskFragment } })
    | null;
...
type BackupTask_JobSubTask_Fragment = {
  __typename: 'JobSubTask';
  taskName: string;
  description?: string | null;
  state?: QueueTaskState | null;
  progression?:
    | ({ __typename?: 'JobProgression' } & { ' $fragmentRefs'?: { ProgressTaskFragment: ProgressTaskFragment } })
    | null;
} & { ' $fragmentName'?: 'BackupTask_JobSubTask_Fragment' };
...
export const EventRefCountInformationFragmentDoc = {
  ...
  definitions: [
    {
      kind: 'FragmentDefinition',
      name: { kind: 'Name', value: 'EventRefCountInformation' },
      typeCondition: { kind: 'NamedType', name: { kind: 'Name', value: 'EventRefCountInformation' } },
      selectionSet: {
        kind: 'SelectionSet',
        selections: [
...
} as unknown as DocumentNode<EventRefCountInformationFragment, unknown>;
            ...
            selectionSet: {
              ...
              selections: [
                ...
                },
                {
                  ...
                  selectionSet: {
                    kind: 'SelectionSet',
                    selections: [{ kind: 'FragmentSpread', name: { kind: 'Name', value: 'EventRefCountInformation' } }],
                  },
                },
                {
                  kind: 'InlineFragment',
...
export const ProgressTaskFragmentDoc = {
  kind: 'Document',
  definitions: [
    {
      kind: 'FragmentDefinition',
      name: { kind: 'Name', value: 'ProgressTask' },
      typeCondition: { kind: 'NamedType', name: { kind: 'Name', value: 'JobProgression' } },
      selectionSet: {
        kind: 'SelectionSet',
        selections: [
...
} as unknown as DocumentNode<ProgressTaskFragment, unknown>;
export const TaskDescriptionFragmentDoc = {
  kind: 'Document',
  definitions: [
    {
      kind: 'FragmentDefinition',
      name: { kind: 'Name', value: 'TaskDescription' },
      typeCondition: { kind: 'NamedType', name: { kind: 'Name', value: 'SubTaskOrGroupTasks' } },
      selectionSet: {
        kind: 'SelectionSet',
        selections: [
          { kind: 'Field', name: { kind: 'Name', value: '__typename' } },
          {
            kind: 'InlineFragment',
            typeCondition: { kind: 'NamedType', name: { kind: 'Name', value: 'JobSubTask' } },
            selectionSet: {
              kind: 'SelectionSet',
              selections: [
...
} as unknown as DocumentNode<TaskDescriptionFragment, unknown>;
export const BackupTaskFragmentDoc = {
  kind: 'Document',
  definitions: [
    {
      kind: 'FragmentDefinition',
      name: { kind: 'Name', value: 'BackupTask' },
      typeCondition: { kind: 'NamedType', name: { kind: 'Name', value: 'SubTaskOrGroupTasks' } },
      selectionSet: {
        kind: 'SelectionSet',
        selections: [
          ...
          {
            kind: 'InlineFragment',
            typeCondition: { kind: 'NamedType', name: { kind: 'Name', value: 'JobGroupTasks' } },
            selectionSet: {
              kind: 'SelectionSet',
              selections: [
                ...
                { kind: 'Field', name: { kind: 'Name', value: 'state' } },
                {
                  ...
                  selectionSet: {
                    kind: 'SelectionSet',
                    selections: [{ kind: 'FragmentSpread', name: { kind: 'Name', value: 'ProgressTask' } }],
                  },
                },
                {
                  kind: 'Field',
                  alias: { kind: 'Name', value: 'taskDescription' },
                  name: { kind: 'Name', value: 'subtasks' },
                  selectionSet: {
                    kind: 'SelectionSet',
                    selections: [{ kind: 'FragmentSpread', name: { kind: 'Name', value: 'TaskDescription' } }],
                  },
                },
              ],
            },
...
} as unknown as DocumentNode<BackupTaskFragment, unknown>;
            ...
            selectionSet: {
              ...
              selections: [
                ...
                },
                {
                  ...
                  selectionSet: {
                    kind: 'SelectionSet',
                    selections: [{ kind: 'FragmentSpread', name: { kind: 'Name', value: 'BackupTask' } }],
                  },
                },
              ],
            },
        ...
        selections: [
          {
            ...
            selectionSet: {
              ...
              selections: [
                ...
                { kind: 'Field', name: { kind: 'Name', value: 'lastBackupState' } },
        ...
        selections: [
          {
            ...
            selectionSet: {
              kind: 'SelectionSet',
              selections: [{ kind: 'Field', name: { kind: 'Name', value: 'void' } }],
            },
          },
        ],
      },
...
} as unknown as DocumentNode<FsckPoolMutation, FsckPoolMutationVariables>;
export const VerifyChecksumDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'mutation',
      name: { kind: 'Name', value: 'verifyChecksum' },
      selectionSet: {
        kind: 'SelectionSet',
        selections: [
          {
...
} as unknown as DocumentNode<VerifyChecksumMutation, VerifyChecksumMutationVariables>;
