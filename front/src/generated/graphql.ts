...
export type EventInformation = EventBackupInformation | EventHashConversionInformation | EventPoolCleanedInformation | EventPoolInformation | EventRefCountInformation;
...
export type EventPoolInformation = {
  ...
  inNothing: Scalars['Float']['output'];
  inRefcnt: Scalars['Float']['output'];
  inUnused: Scalars['Float']['output'];
  missing: Scalars['Float']['output'];
};

export type EventRefCountInformation = {
  __typename?: 'EventRefCountInformation';
  count: Scalars['Float']['output'];
...
export type RestoreInput = {
  destinationDirectory?: InputMaybe<Scalars['String']['input']>;
...
export type ApplicationEventFragment = { __typename?: 'ApplicationEvent', uuid: string, type: EventType, step: EventStep, source: EventSource, timestamp: string, errorMessages: Array<string>, status: EventStatus, information?: (
    ...
    { __typename: 'EventRefCountInformation' }
    & { ' $fragmentRefs'?: { 'EventRefCountInformationFragment': EventRefCountInformationFragment } }
...
export type EventRefCountInformationFragment = { __typename?: 'EventRefCountInformation', fix: boolean, count: number, error: number } & { ' $fragmentName'?: 'EventRefCountInformationFragment' };

export type EventPoolInformationFragment = { __typename?: 'EventPoolInformation', fix: boolean, inUnused: number, inRefcnt: number, inNothing: number, missing: number } & { ' $fragmentName'?: 'EventPoolInformationFragment' };

export type EventPoolCleanedInformationFragment = { __typename?: 'EventPoolCleanedInformation', size: number, count: number } & { ' $fragmentName'?: 'EventPoolCleanedInformationFragment' };

export type EventHashConversionInformationFragment = { __typename?: 'EventHashConversionInformation', count: number, algorithm: string } & { ' $fragmentName'?: 'EventHashConversionInformationFragment' };

export type HostsQueryVariables = Exact<{ [key: string]: never; }>;


export type HostsQuery = { __typename?: 'Query', hosts: Array<{ __typename?: 'Host', name: string, agentVersion?: string | null, availibilityState?: HostAvailibilityState | null, timeSinceLastBackup?: number | null, dateToNextBackup?: string | null, lastBackupState?: string | null, lastBackup?: { __typename?: 'Backup', number: number, startDate: number, fileSize: bigint, completed: boolean, agentVersion?: string | null } | null, configuration: { __typename?: 'HostConfiguration', schedule?: { __typename?: 'Schedule', activated?: boolean | null } | null } }> };
...
export type FsckPoolMutation = { __typename?: 'Mutation', checkAndFixPool: (
    { __typename?: 'JobResponse' }
    & { ' $fragmentRefs'?: { 'JobPoolResponseFragment': JobPoolResponseFragment } }
  ) };
...
export type VerifyChecksumMutation = { __typename?: 'Mutation', verifyChecksum: (
    { __typename?: 'JobResponse' }
    & { ' $fragmentRefs'?: { 'JobPoolResponseFragment': JobPoolResponseFragment } }
  ) };
...
export type ProgressTaskFragment = { __typename?: 'JobProgression', progressCurrent?: bigint | null, progressMax?: bigint | null, fileSize?: bigint | null, newFileSize?: bigint | null, compressedFileSize?: bigint | null, newCompressedFileSize?: bigint | null, fileCount?: number | null, newFileCount?: number | null, errorCount?: number | null, percent?: number | null, speed?: number | null } & { ' $fragmentName'?: 'ProgressTaskFragment' };
...
export const EventRefCountInformationFragmentDoc = {"kind":"Document","definitions":[{"kind":"FragmentDefinition","name":{"kind":"Name","value":"EventRefCountInformation"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"EventRefCountInformation"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"fix"}},{"kind":"Field","name":{"kind":"Name","value":"count"}},{"kind":"Field","name":{"kind":"Name","value":"error"}}]}}]} as unknown as DocumentNode<EventRefCountInformationFragment, unknown>;
