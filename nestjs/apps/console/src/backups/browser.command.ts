import { BackupOperation, FileBrowserService, globStringToRegex, HostsService, longToBigInt } from '@woodstock/shared';
...
export class BrowserCommand {
  ...
  async importFromBackuppc(host: string, path: string, options: { verbose: boolean }): Promise<void> {
