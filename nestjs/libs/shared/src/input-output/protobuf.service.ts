...
import { fromNodeStream, notUndefined, tmpNameAsync } from '../utils';
import type { ProtobufMessageWithPosition } from './protobuf.interfaces';
import { ProtobufMessageReader } from './transform/protobuf-message-reader.utils.js';
...
export class ProtobufService {
  #logger = new Logger(ProtobufService.name);
